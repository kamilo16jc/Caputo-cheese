...
function exportHoldPDF() {
  ...
  var doc = '<!DOCTYPE html><html><head><meta charset="UTF-8"><style>body{font-family:Arial,sans-serif;font-size:10px;padding:20px;background:white}@page{size:portrait;margin:0}@media print{body{padding:12mm}}</style></head><body>'+
